"""an_efficient_privacy_enhancing URL Configuration
...
from an_efficient_privacy_enhancing import settings
...
urlpatterns = [
    ...
    url(r'^Predict_false_data_injection_attack_detection/$', remoteuser.Predict_false_data_injection_attack_detection, name="Predict_false_data_injection_attack_detection"),
    ...
    url(r'^View_false_data_injection_attack_detection_Ratio/$', serviceprovider.View_false_data_injection_attack_detection_Ratio, name="View_false_data_injection_attack_detection_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^View_false_data_injection_attack_detection_Type/$', serviceprovider.View_false_data_injection_attack_detection_Type, name="View_false_data_injection_attack_detection_Type"),
